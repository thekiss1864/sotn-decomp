...
static u16 D_170000_8017A808[N_ARRAY_PAL][COLORS_PER_PAL] = {
    {0x0000, 0x9063, 0x8297, 0xB33F, 0x800F, 0x8016, 0x843C, 0xA11F, 0x9CC6,
     0xAD29, 0xB98C, 0xC5EF, 0xD252, 0xE2B5, 0xEF18, 0xFB9C},
    {0x0000, 0x8421, 0x8444, 0x8467, 0x84AB, 0x88ED, 0x8D30, 0x9573, 0x9994,
     0x9DB6, 0xA1F7, 0xA619, 0xE2F4, 0xAE7C, 0xCA52, 0xB6DF},
    {0x0000, 0x8421, 0xA86A, 0xB8CD, 0xCD6F, 0xE24F, 0x8D2F, 0x91D6, 0x929B,
     0x9084, 0x9D08, 0xA96C, 0xB9F0, 0xC654, 0xD2D8, 0xE35C},
    {0x0000, 0x8421, 0x98A3, 0xAD2A, 0xCA52, 0xAC61, 0xC503, 0xD9A7, 0xE2AF,
     0x9084, 0x9D08, 0xA96C, 0xB9F0, 0x801F, 0xD2D8, 0xE35C},
    {0x0000, 0x8822, 0x83E0, 0xECE5, 0xF68A, 0x8048, 0x884C, 0x88B5, 0x8D39,
     0x821C, 0x9CA4, 0xAD29, 0xBDAD, 0xD231, 0xE6B5, 0xEB7A},
    {0x0000, 0x9821, 0x8D2F, 0x9594, 0xA219, 0x92FF, 0x9099, 0x98DF, 0xB4E8,
     0x9084, 0xA109, 0xAD6C, 0xBA11, 0xC654, 0xD2D8, 0xE35C},
    {0x0000, 0x8421, 0x9084, 0xA8E5, 0xC146, 0xFF53, 0x9084, 0x9084, 0x9084,
     0x9084, 0x9084, 0x9084, 0x9084, 0x9084, 0x9084, 0x9084},
    {0x0000, 0x9509, 0x8842, 0x98C7, 0xA508, 0xB16B, 0xBDCD, 0xD292, 0xE316,
     0xF379, 0x88C2, 0x98E4, 0xA164, 0x84CA, 0x9191, 0xAA34},
    {0x0000, 0x8421, 0x9007, 0x9869, 0x94A7, 0x990B, 0x8D2F, 0x91D6, 0x929B,
     0x9084, 0x9D08, 0xA96C, 0xB9F0, 0xC654, 0xD2D8, 0xE35C},
    {0x0000, 0xB31C, 0x8219, 0x80F6, 0x800E, 0x80A0, 0x9D80, 0xC5A0, 0xCEA0,
     0x8421, 0x806A, 0x8151, 0x8299, 0xB18C, 0xD294, 0x8019},
    {0x0000, 0xD717, 0xC272, 0xB5EE, 0x9D4B, 0x98C8, 0x8C85, 0x8842, 0x90E2,
     0xA546, 0xDAD6, 0x8CA9, 0x9953, 0x99B6, 0xA659, 0xF39C},
    {0x0000, 0x8421, 0x90A5, 0xA12A, 0xB1AE, 0xC233, 0xD2D8, 0x908B, 0x8013,
     0x801F, 0x9D70, 0xA6FE, 0xAF5F, 0x921D, 0x965D, 0x9EBE}};
...
static u16* g_WeaponCluts[] = {(u16*)D_170000_8017A808};
...
static void EntityWeaponShieldSpell(Entity* self) {
    ...
    case 1:
        ...
        self->ext.shield.unk94 = self->scaleX;
    ...
    case 4:
        ...
        self->ext.shield.childPalette = self->scaleX * 36 / 256;
        self->ext.shield.unk8A = self->scaleX * 28 / 256;
        prim = &g_PrimBuf[self->primIndex];
        if (prim->b3 > 8) {
            prim->b3 -= 4;
        }
