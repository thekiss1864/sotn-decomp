...
static u16 D_35000_8017A884[N_ARRAY_PAL][COLORS_PER_PAL] = {
    {COLOR16(0, 0, 0, 0), COLOR16(4, 4, 5, 0), COLOR16(0, 0, 0, 1),
     ...
     COLOR16(25, 26, 27, 0)},
    {COLOR16(0, 0, 0, 0), COLOR16(0, 2, 29, 0), COLOR16(0, 11, 31, 0),
     COLOR16(0, 21, 31, 0), COLOR16(3, 28, 31, 0), COLOR16(9, 11, 14, 0),
     COLOR16(16, 13, 22, 0), COLOR16(16, 0, 7, 0), COLOR16(26, 11, 7, 0),
     COLOR16(31, 26, 7, 0), COLOR16(2, 2, 2, 0), COLOR16(6, 6, 6, 0),
     COLOR16(10, 10, 10, 0), COLOR16(15, 15, 16, 0), COLOR16(20, 20, 21, 0),
     COLOR16(25, 28, 27, 0)},
    {COLOR16(0, 0, 0, 0), COLOR16(4, 10, 13, 1), COLOR16(8, 13, 17, 1),
     COLOR16(9, 5, 5, 0), COLOR16(13, 10, 8, 0), COLOR16(23, 16, 8, 0),
     COLOR16(28, 22, 13, 0), COLOR16(4, 5, 7, 0), COLOR16(5, 7, 12, 0),
     COLOR16(8, 12, 18, 0), COLOR16(21, 19, 11, 0), COLOR16(14, 15, 7, 0),
     COLOR16(7, 8, 9, 0), COLOR16(10, 12, 13, 0), COLOR16(14, 16, 18, 0),
     COLOR16(20, 22, 22, 0)},
    ...
    {COLOR16(0, 0, 0, 0), COLOR16(0, 18, 11, 0), COLOR16(0, 26, 12, 0),
     ...
     COLOR16(25, 28, 27, 0)},
    {COLOR16(0, 0, 0, 0), COLOR16(4, 4, 5, 0), COLOR16(0, 0, 0, 1),
     COLOR16(6, 2, 1, 0), COLOR16(9, 7, 14, 0), COLOR16(11, 10, 17, 0),
     COLOR16(15, 4, 5, 0), COLOR16(0, 31, 1, 0), COLOR16(0, 31, 0, 0),
     COLOR16(0, 31, 0, 0), COLOR16(2, 2, 2, 0), COLOR16(3, 5, 8, 0),
     COLOR16(7, 9, 11, 0), COLOR16(13, 14, 16, 0), COLOR16(20, 20, 21, 0),
     COLOR16(25, 28, 30, 0)},
    {COLOR16(0, 0, 0, 0), COLOR16(31, 12, 1, 0), COLOR16(31, 17, 10, 0),
     ...
     COLOR16(10, 10, 10, 0), COLOR16(15, 15, 16, 0), COLOR16(20, 20, 21, 0),
     COLOR16(25, 28, 27, 0)},
    {COLOR16(0, 0, 0, 0), COLOR16(1, 2, 4, 0), COLOR16(6, 5, 31, 0),
     COLOR16(6, 1, 27, 0), COLOR16(6, 12, 22, 0), COLOR16(6, 2, 22, 0),
     ...
     COLOR16(10, 12, 22, 0)},
    {COLOR16(0, 0, 0, 0), COLOR16(1, 3, 8, 0), COLOR16(5, 4, 28, 0),
     COLOR16(4, 1, 23, 0), COLOR16(18, 22, 22, 0), COLOR16(6, 12, 22, 0),
    ...
    {COLOR16(0, 0, 0, 0), COLOR16(1, 3, 8, 0), COLOR16(3, 2, 22, 0),
     COLOR16(2, 1, 15, 0), COLOR16(14, 15, 22, 0), COLOR16(16, 18, 22, 0),
     COLOR16(18, 22, 22, 0), COLOR16(6, 12, 22, 0), COLOR16(6, 2, 22, 0),
     COLOR16(8, 5, 22, 0), COLOR16(10, 8, 22, 0), COLOR16(12, 12, 22, 0),
     COLOR16(9, 26, 23, 0), COLOR16(26, 27, 29, 0), COLOR16(7, 5, 16, 0),
     COLOR16(10, 12, 22, 0)},
    {COLOR16(0, 0, 0, 0), COLOR16(1, 2, 4, 0), COLOR16(3, 1, 19, 0),
     COLOR16(1, 2, 12, 0), COLOR16(12, 12, 22, 0), COLOR16(14, 15, 22, 0),
    ...
    {COLOR16(0, 0, 0, 0), COLOR16(1, 3, 8, 0), COLOR16(3, 2, 22, 0),
     ...
     COLOR16(10, 12, 22, 0)},
    {COLOR16(0, 0, 0, 0), COLOR16(1, 2, 4, 0), COLOR16(4, 3, 25, 0),
     COLOR16(3, 1, 19, 0), COLOR16(8, 5, 22, 0), COLOR16(10, 8, 22, 0),
     COLOR16(12, 12, 22, 0), COLOR16(14, 15, 22, 0), COLOR16(16, 18, 22, 0),
     COLOR16(18, 22, 22, 0), COLOR16(6, 12, 22, 0), COLOR16(6, 2, 22, 0),
     COLOR16(11, 19, 27, 0), COLOR16(9, 26, 23, 0), COLOR16(7, 5, 16, 0),
     COLOR16(10, 12, 22, 0)},
    {COLOR16(0, 0, 0, 0), COLOR16(1, 3, 8, 0), COLOR16(5, 4, 28, 0),
     COLOR16(4, 1, 23, 0), COLOR16(6, 2, 22, 0), COLOR16(8, 5, 22, 0),
     COLOR16(10, 8, 22, 0), COLOR16(12, 12, 22, 0), COLOR16(14, 15, 22, 0),
     COLOR16(16, 18, 22, 0), COLOR16(18, 22, 22, 0), COLOR16(6, 12, 22, 0),
     COLOR16(9, 26, 23, 0), COLOR16(26, 27, 29, 0), COLOR16(7, 5, 16, 0),
     COLOR16(10, 12, 22, 0)},
...
void EntityWeaponAttack(Entity* self) {
    ...
    if (animIndex && PLAYER.poseTimer == 7 && PLAYER.pose == 4) {
        hand = (g_HandId + 1) << 0xC;
