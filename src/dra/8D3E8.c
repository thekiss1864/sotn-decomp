...
void func_8012D3E8(void) {
    ...
    if (!(g_Player.vram_flag & TOUCHING_GROUND) && (D_800B0914 != 4)) {
        func_8012CED4();
        return;
    }
    ...
    case 2:
        ...
        if ((g_Player.vram_flag & TOUCHING_R_WALL) && PLAYER.velocityX > 0 ||
...
void func_8012E040(void) {
    ...
    if ((PLAYER.velocityY < FIX(-1)) &&
        (g_Player.vram_flag & TOUCHING_CEILING)) {
...
void func_8012F894(Entity* self) {
    ...
    if (!(g_Player.vram_flag & TOUCHING_GROUND) || (PLAYER.step_s == 7)) {
        angle = D_80138430;
        if (PLAYER.facingLeft) {
        ...
        while (1) {
            ...
            vram_flag_F000 = g_Player.vram_flag &
                             (TOUCHING_ANY_SLOPE | TOUCHING_RAISING_SLOPE |
                              VRAM_FLAG_UNK2000 | TOUCHING_SLIGHT_SLOPE);
            angle = 0x800;
            if (vram_flag_F000 == (VRAM_FLAG_UNK2000 | TOUCHING_RAISING_SLOPE |
                                   TOUCHING_ANY_SLOPE)) {
                angle = 0x760;
            }
            if (vram_flag_F000 ==
                (TOUCHING_SLIGHT_SLOPE | TOUCHING_RAISING_SLOPE |
                 TOUCHING_ANY_SLOPE)) {
                angle = 0x6D2;
            }
            if (vram_flag_F000 ==
                (TOUCHING_RAISING_SLOPE | TOUCHING_ANY_SLOPE)) {
                angle = 0x600;
            }
            if (vram_flag_F000 == TOUCHING_ANY_SLOPE) {
                angle = 0xA00;
            }
            if (vram_flag_F000 ==
                (TOUCHING_SLIGHT_SLOPE | TOUCHING_ANY_SLOPE)) {
                angle = 0x92E;
            }
            if (vram_flag_F000 == (VRAM_FLAG_UNK2000 | TOUCHING_ANY_SLOPE)) {
                angle = 0x8A0;
            }
            if (PLAYER.facingLeft) {
                angle -= 0x800;
