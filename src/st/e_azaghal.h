...
static SVECTOR sword_face_tl = {.vx = -16, .vy = 8, .vz = 0};
static SVECTOR sword_face_tr = {.vx = 16, .vy = 8, .vz = 0};
static SVECTOR sword_face_bl = {.vx = -16, .vy = 120, .vz = 0};
static SVECTOR sword_face_br = {.vx = 16, .vy = 120, .vz = 0};
static SVECTOR sword_edge_tl = {.vx = 0, .vy = 8, .vz = -8};
static SVECTOR sword_edge_tr = {.vx = 0, .vy = 8, .vz = 8};
static SVECTOR sword_edge_bl = {.vx = 0, .vy = 120, .vz = -8};
static SVECTOR sword_edge_br = {.vx = 0, .vy = 120, .vz = 8};
static SVECTOR sword_tip = {.vx = 0, .vy = 120, .vz = 0};
...
static void func_us_801B33F4(void) {
    ...
    RotTransPers4(&sword_face_tl, &sword_face_tr, &sword_face_bl,
                  &sword_face_br, (long*)&prim->x0, (long*)&prim->x1,
                  (long*)&prim->x2, (long*)&prim->x3, &p, &flag);
    primTwo = g_CurrentEntity->ext.azaghal.primThree;
    primTwo = func_us_801B2C40(&sword_face_tl, &sword_face_tr, &sword_face_bl,
                               &sword_face_br, prim, 3, primTwo, (u8*)SPAD(0));
    prim->drawMode = DRAW_HIDE;
    prim = prim->next;

    prim->drawMode = DRAW_UNK02;
    RotTransPers4(&sword_edge_tl, &sword_edge_tr, &sword_edge_bl,
                  &sword_edge_br, (long*)&prim->x0, (long*)&prim->x1,
                  (long*)&prim->x2, (long*)&prim->x3, &p, &flag);
    primTwo = func_us_801B2C40(&sword_edge_tl, &sword_edge_tr, &sword_edge_bl,
                               &sword_edge_br, prim, 3, primTwo, (u8*)SPAD(0));
    prim->drawMode = DRAW_HIDE;
    ...
    if (g_CurrentEntity->flags & FLAG_DEAD) {
        ...
        RotTransPers(&sword_tip, (long*)SPAD(0), &p, &flag);
