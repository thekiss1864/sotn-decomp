...
static u16 g_testCollPrizeTable[] = {
    ITEMDROP_GOLD_1,      ITEMDROP_GOLD_2,      ITEMDROP_GOLD_2,
    ITEMDROP_GOLD_2,      ITEMDROP_GOLD_2,      ITEMDROP_GOLD_2,
    ITEMDROP_GOLD_2,      ITEMDROP_GOLD_2,      ITEMDROP_GOLD_3,
    ITEMDROP_GOLD_3,      ITEMDROP_GOLD_3,      ITEMDROP_GOLD_3,
    ITEMDROP_GOLD_3,      ITEMDROP_GOLD_4,      ITEMDROP_GOLD_4,
    ITEMDROP_GOLD_4,      ITEMDROP_SMALL_HEART, ITEMDROP_SMALL_HEART,
    ITEMDROP_SMALL_HEART, ITEMDROP_SMALL_HEART, ITEMDROP_SMALL_HEART,
    ITEMDROP_SMALL_HEART, ITEMDROP_SMALL_HEART, ITEMDROP_SMALL_HEART,
    ITEMDROP_SMALL_HEART, ITEMDROP_SMALL_HEART, ITEMDROP_SMALL_HEART,
    ITEMDROP_SMALL_HEART, ITEMDROP_LARGE_HEART, ITEMDROP_LARGE_HEART,
    ITEMDROP_LARGE_HEART, ITEMDROP_LARGE_HEART,
};
